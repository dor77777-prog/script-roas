...
export const CAMPAIGNS_COLUMNS: ReadonlyArray<{
  ...
  { id: 'firstClickRoas', label: 'ROAS first-click (מבוא ללקוח)', description: 'ROAS לפי המגע הראשון של הלקוח (ft_* בעגלה / utm_id). מודד כמה הקמפיין מכניס לקוחות חדשים — לא רק סוגר. עיוור ל-Google. כיסוי תמיד <= last-click.' },
