...
> = {
  critical: {
    groupBg:     'bg-status-redBg',
    groupBorder: 'border-status-red',
    groupHeader: 'text-status-redFg',
    badge:       'bg-status-redBtn text-accent-fg',
    iconBadge:   'bg-status-redBg text-status-redFg ring-status-red',
  },
  warning: {
    groupBg:     'bg-status-warningBg',
    groupBorder: 'border-status-warning',
    groupHeader: 'text-status-warningFg',
    badge:       'bg-status-orangeBtn text-accent-fg',
    iconBadge:   'bg-status-warningBg text-status-warningFg ring-status-warning',
  },
  opportunity: {
    groupBg:     'bg-accent-bg',
    groupBorder: 'border-accent',
    groupHeader: 'text-accent',
    badge:       'bg-accent-btn text-accent-fg',
    iconBadge:   'bg-status-blueBg text-status-blueFg ring-status-blue',
  },
  positive: {
    groupBg:     'bg-status-greenBg',
    groupBorder: 'border-status-green',
    groupHeader: 'text-status-greenFg',
    badge:       'bg-status-greenBtn text-accent-fg',
    iconBadge:   'bg-status-greenBg text-status-greenFg ring-status-green',
  },
  info: {
    groupBg:     'bg-glass-2',
