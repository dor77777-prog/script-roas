...
> = {
  critical: {
    ...
    badge:       'bg-status-red text-accent-fg',
    iconBadge:   'bg-status-redBg text-status-red ring-status-red',
  },
  warning: {
    groupBg:     'bg-status-warningBg',
    groupBorder: 'border-status-warning',
    groupHeader: 'text-status-warningFg',
    badge:       'bg-status-warning text-accent-fg',
  ...
  opportunity: {
    ...
    iconBadge:   'bg-status-blueBg text-status-blue ring-status-blue',
  },
  positive: {
    groupBg:     'bg-status-greenBg',
    groupBorder: 'border-status-green',
    groupHeader: 'text-status-green',
    badge:       'bg-status-green text-accent-fg',
    iconBadge:   'bg-status-greenBg text-status-green ring-status-green',
  },
  info: {
    groupBg:     'bg-glass-2',
