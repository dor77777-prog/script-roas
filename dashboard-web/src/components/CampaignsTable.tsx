  ...
  const summary = aggregated.length > 0 && (
    <div className="px-4 sm:px-5 py-3 sm:py-4 bg-pill-track border-b border-glass-edge">
      ...
      {cpmExpanded && cpmDaily.length >= 2 && (
        <CpmTrendChart
          cpmDaily={cpmDaily}
          cpmDailyPrev={cpmDailyPrev}
          range={localRange}
          prevRange={cpmPrevRange}
          scopeLabel={
            <>
          ...
          onModeChange={setCpmAnalysisMode}
          isLoadingPrev={cpmAnalysisMode === 'prev' && !cpmPrevData}
          onClose={() => setCpmExpanded(false)}
        />
      )}
      {totals.spend > 0 && (
