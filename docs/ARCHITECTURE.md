...
>
> **גרסה**: 1.4 · **תאריך**: 2026-06-03 · **בסיס קוד**: Phase 05.7.x + mesh exact re-skin + NC-ROAS / first-click + Wave 2 customer-value (cohorts / LTV) tab
