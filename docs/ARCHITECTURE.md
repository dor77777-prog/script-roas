...
**הערה היסטורית:** הגרסה הראשונה של Phase A.5 (commit `fee0e9b`) הוסיפה את ה-UI כעמודת טבלה ב-CampaignsTable. ב-feedback מהאופרטור 2026-05-29: "column-tagging זה anti-pattern" — מוזז ל-CampaignDrawer במקום זאת. ה-CampaignsTable column הוסר.
