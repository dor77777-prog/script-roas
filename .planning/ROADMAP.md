...
- [ ] 05.2.3.0-05-PLAN.md — Rolling 3-day backfill in 3 per-store live wrappers + legacy runLiveUpdate manual entry (DailyUpdate.gs D-D1). Wave 3, autonomous: true. Depends on 02.
- [ ] 05.2.3.0-06-PLAN.md — 3 per-store 20-day cleanup menu items in Main.gs (D-D2 verbatim Hebrew strings: רענן הכנסות (20 ימים) — uzoshop / Zol Plus / 360usmile) + refreshRevenue20Days*_ handlers. Wave 3, autonomous: true. Depends on 01.
